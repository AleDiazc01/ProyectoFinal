...
CREATE TABLE recetasdecasa.cliente (
...
INSERT INTO recetasdecasa.cliente (id_cliente, nombre, apellidos, correo, contra) VALUES 
(1, 'andres', 'lopez', 'andres@gmail.com', 'sas123'),
(2, 'César', 'valverde', 'cesar@gmail.com', 'sos123');
...
/*Se insertan 3 registros en la tabla cliente como ejemplo */
INSERT INTO recetasdecasa.receta (id_receta,id_cliente, nombre, descripcion, ingredientes, preparacion) VALUES 
